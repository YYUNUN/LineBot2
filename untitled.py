...
# 初始的 texts 列表
texts = [
    ['必勝客', '拿波里', '肯德基', '麥當勞', 'ABV 美式餐酒館', 'AK12美式小館', 'H&W Restaurant and Bar', '發福廚房', '金色三麥', 'the Chips', '樂子 the Diner', 'Campus cafe', 'Housebistro好適廚坊', '夜。店 新美式景觀餐廳', 'Burger&CO', 'Bugel Bagel'],
    ['頤宮', '興蓬萊台菜餐廳', '國賓中餐廳', '朧粵 Longyue', '捌伍添第 85TD', '喜來登', '私廚‧小酒棧', 'THE上海', '天香樓Tien Hsiang Lo', '今大滷肉飯', '吉甜不辣', '鑫鱻熱炒', '阿城鵝肉', '丰禾台式小館', '山海樓', '青葉台灣料理', '金蓬萊遵古台菜'],
    ...
    ['瓦城', '1010湘', '大心', '泰鑽泰式料理', '哈哈囉55泰式船面', 'Lisa泰式美食', 'Kanokwan 老麵攤', '泰街頭', '三攀泰泰國料理', '泰鼎泰式料理', '泰獅泰式料理', '泰樂泰國料理', '非常泰', '時時湘', '月月Thai BBQ', '樂子the Diner', 'BO BO'],
    ['欣葉日本料理', 'NAGOMI', '彩日本料理', '金子半之助 ', '九州鬆餅', '日本橋海鮮丼つじ半', '丼飯店', '心 KOKORO 食堂', '大和日本料理', '三井料理美術館', 'THE·春日式料理', '打狗霸 TAKAO 1972', '三多屋爸爸嘴', '安吉食堂']
]
